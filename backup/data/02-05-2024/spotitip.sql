...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2024 at 07:16 AM
...
('PL01', '2lit2quit', 4, NULL),
('PL02', 'maybe im the problem', 5, NULL),
('PL03', 'all too well', 3, NULL),
('PL04', 'what for', 3, NULL),
('PL05', 'adrenaline rush', 1, NULL),
('PL06', 'the day that i met you', 4, NULL),
('PL07', 'i sleep so that we can meet', 3, NULL),
('PL08', 'im scared this is all i will be', 4, NULL),
('PL09', 'its okay to feel sad', 7, NULL),
...
--
-- Dumping data for table `song_playlist_contains`
--

INSERT INTO `song_playlist_contains` (`playlist_id`, `song_id`) VALUES
('PL01', 'SO18'),
('PL01', 'SO19'),
('PL01', 'SO20'),
('PL01', 'SO21'),
...
--
-- Dumping data for table `user_song_liked`
--

INSERT INTO `user_song_liked` (`user_id`, `song_id`) VALUES
('US01', 'SO01');
