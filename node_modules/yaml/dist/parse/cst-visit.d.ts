import type { CollectionItem, Document } from 'yaml/dist/parse/cst.js';
...
export declare namespace visit {
    ...
    var parentCollection: (cst: Document | CollectionItem, path: VisitPath) => import("yaml/dist/parse/cst.js").BlockMap | import("yaml/dist/parse/cst.js").BlockSequence | import("yaml/dist/parse/cst.js").FlowCollection;
}
