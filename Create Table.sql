...
CREATE TABLE IF NOT EXISTS `album` (
  `id` varchar(12) NOT NULL, `title` varchar(50) NOT NULL,
  `release` date NOT NULL, `duration` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ;

CREATE TABLE IF NOT EXISTS `album_artist_has` (
  `album_id` varchar(12) NOT NULL, `artist_id` varchar(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `playlist` (
  ...
  `num_song` int(11) DEFAULT NULL, `duration` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
);

CREATE TABLE IF NOT EXISTS `playlist_song_contains` (
  `playlist_id` varchar(12) NOT NULL, `song_id` varchar(12) NOT NULL,
  KEY `playlist_id_contains` (`playlist_id`), KEY `song_id_contains` (`song_id`),
...
CREATE TABLE IF NOT EXISTS `song` (
  ...
  `duration` int(11) NOT NULL DEFAULT 0, `listeners` int(11) DEFAULT 0,
  PRIMARY KEY (`id`)
);

CREATE TABLE IF NOT EXISTS `song_album_contains` (
  `song_id` varchar(12) NOT NULL, `album_id` varchar(12) NOT NULL,
  KEY `song_id` (`song_id`), KEY `album_id` (`album_id`),
...
CREATE TABLE IF NOT EXISTS `user_playlist_follow` (
  ...
  KEY `playlist_id_follow` (`playlist_id`), KEY `user_id_follow` (`user_id`),
...
CREATE TABLE IF NOT EXISTS `user_song_liked` (
  `user_id` varchar(12) NOT NULL, `song_id` varchar(12) NOT NULL,
  KEY `user_id_liked` (`user_id`), KEY `song_id_liked` (`song_id`),
